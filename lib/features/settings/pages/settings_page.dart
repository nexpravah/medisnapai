      ...
      body: Column(
        children: [
                  ...
                  itemBuilder: (context, index) {
                    return Obx(
                      () => RadioListTile(
                        ...
                        selected:
                            languageController.localLanguage.value ==
                        ...
                        onChanged:
                            (val) => languageController.setLanguage(
                              AppConstants.languages[index][3],
                            ),
                      ),
                    );
                  },
                    ...
                    itemBuilder: (context, index) {
                      return Obx(
                        () => RadioListTile(
                          ...
                          title: Text(
                            AppConstants.themes[index][0].toString().tr,
                          ),
          ...
          ListTile(
            ...
            onTap: () {
              Get.toNamed(AppPageRoute.privacyPolicy);
            },
            title: Text("privacy_policy".tr),
            subtitle: Text("privacy_policy".tr),
          ),
          ListTile(
            leading: const Icon(Icons.description),
            onTap: () {
              Get.toNamed(AppPageRoute.termsAndCondition);
            },
            title: Text("terms_and_condition".tr),
            subtitle: Text("terms_and_condition".tr),
          ),
          ListTile(
            leading: const Icon(Icons.contact_page),
            onTap: () {
              Get.toNamed(AppPageRoute.aboutUs);
            },
            title: Text("about_us".tr),
            subtitle: Text("about_us".tr),
          ),
        ],
      ),
    );
